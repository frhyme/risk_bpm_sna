...
print(nx.info(m_g))
print("Degree")
print("weighted graph:", nx.degree(g))
print("unweighted graph:", nx.degree(uw_g))
print("muti_graph:", nx.degree(m_g))
print("centrality")
print("weighted graph:", nx.degree_centrality(g))
print(nx.degree_centrality(uw_g))
print("muti_graph:", nx.degree_centrality(m_g))
print("closeness")
print("weighted graph:", nx.closeness_centrality(g))
print("unweighted graph:", nx.closeness_centrality(uw_g))
print("weighted_graph:", nx.closeness_centrality(g, distance="weight"))
print("flow weighted graph:", nx.current_flow_closeness_centrality(g))
print("muti_graph:", nx.closeness_centrality(m_g))
print("betweenness")
print("weighted graph:", nx.betweenness_centrality(g))
print("unweighted graph:", nx.betweenness_centrality(uw_g))
print("weighted graph:", nx.betweenness_centrality(g, weight="weight"))
print("flow weighted graph:", nx.current_flow_betweenness_centrality(g))
print("multi_graph:",nx.betweenness_centrality(m_g))
